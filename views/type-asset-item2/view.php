...
$this->title = CommonActionLabelEnum::DETAIL.' '. AppVocabularySearch::getValueByKey('Type Asset Item 2');
//$this->params['breadcrumbs'][] = ['label' => CommonActionLabelEnum::LIST.' Type Asset Item 2', 'url' => ['index']];
//$this->params['breadcrumbs'][] = $this->title;
\yii\web\YiiAsset::register($this);
?>
<div class="type-asset-item2-view box box-success">
    ...
    <div class="box-header with-border">
        ...
        <?php
        $tableName = TypeAssetItem2::tableName(); //Ini yang diganti (Nama tabel dari modelnya)
