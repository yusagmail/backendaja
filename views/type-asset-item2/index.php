...
/* @var $searchModel backend\models\TypeAssetItem2Search */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = CommonActionLabelEnum::LIST_ALL . " " . AppVocabularySearch::getValueByKey('Type Asset Item 2');
$this->params['breadcrumbs'][] = $this->title;

$datalist = ['' => CommonActionLabelEnum::CHOOSE, '1' => CommonActionLabelEnum::ACTIVE, '0' => CommonActionLabelEnum::IN_ACTIVE]
?>
<div class="type-asset-item2-index box box-success">
    ...
    <div class="box-header with-border">
        <p>
            <?= Html::a(CommonActionLabelEnum::CREATE . " " . AppVocabularySearch::getValueByKey('Type Asset Item 2'), ['create'], ['class' => 'btn btn-success']) ?>
        </p>
    </div>
    ...
    <div class="box-body table-responsive">
        ...
        $listColumnDynamic = AppFieldConfigSearch::getListGridView(TypeAssetItem2::tableName());
