...
<div class="asset-master-index box box-success">
    ...
    <div class="box-header with-border">
        <p>
            <?= Html::a(CommonActionLabelEnum::CREATE.' '.AppVocabularySearch::getValueByKey('Asset').' '. AppVocabularySearch::getValueByKey('Item'), ['asset-master-item/view-stock', 'i'=>$i, 'action'=>'create_single'], ['class' => 'btn btn-success']) ?>
