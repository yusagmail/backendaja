...
//Sumber : https://gojs.net/latest/samples/orgChartStatic.html
?>
  ...
  <link href="https://fonts.googleapis.com/css?family=Roboto:400,500" rel="stylesheet" type="text/css">
    ...
    function init() {
          ...
          $(go.Panel, "Vertical",
            ...
            $(go.Panel, "Vertical",
              ...
              $(go.TextBlock, textStyle("boss"),
                new go.Binding("text", "headOf", head => "Head of: " + boss.name)
              ),
              $(go.TextBlock, textStyle("boss"),
      ...
      var nodeDataArray = [
        ...
        { key: 1, boss: 0, name: "Frame", nation: "Ireland", title: "FRA" },
