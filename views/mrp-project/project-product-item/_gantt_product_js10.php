...
$this->registerJsFile('@web/chartjs/Chart.js');
$this->registerJsFile('@web/chartjs/moment.min.js');
$this->registerJsFile('@web/chartjs/Chart.min.js');
?>
        ...
        xAxes: [{
            ...
            ticks: {
                ...
                userCallback: function(value, index, values) {
                  ...
                  labelDateRes = (labelDate.toLocaleDateString("en-US")); 
