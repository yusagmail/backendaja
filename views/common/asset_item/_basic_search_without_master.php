...
<div class="asset-master-request-search">
	...
	*/
	?>
<!--    --><?php
//    $datas = array(AssetMaster::BELONG_TO, id_asset_item, '', 'on'=>'...');
//    $listValueAssetMaster = array();
//    foreach($datas as $data){
//        if(isset($data->assetMaster)){
//            $listValueAssetMaster[$data->id_asset_master] = $data->assetMaster->asset_name.' - '.$data->asset_code;
//        }else{
//            $listValueAssetMaster[$data->id_asset_master] = $data->id_asset_master.' - '.$data->asset_code;
//        }
//    }
//
//    echo $form->field($model, 'id_asset_master')->widget(Select2::classname(), [
//        'data' => $listValueAssetMaster,
//        'options' => ['placeholder' => 'Pilih Asset'],
//        'pluginOptions' => [
//            'allowClear' => true
//        ],
