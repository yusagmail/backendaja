...
$img = AppSettingSearch::getImageUrl("LOGO", $imgdefault);
...
<div class="login-box">
    ...
    <!-- /.login-logo -->
    <div class="login-box-body" style="background-color: rgba(255, 255, 255)">
        <p class="login-box-msg"><?= Html::img($img, ['class' => 'img-square', 'width'=>240]) ?></p>
        ...
        <div class="row">
            ...
            <!-- /.col -->
            <div class="col-xs-4">
                <?= Html::submitButton('Sign in', ['class' => 'btn btn-primary btn-block btn-sm', 'name' => 'login-button']) ?>
            </div>
            <!-- /.col -->
        </div>
