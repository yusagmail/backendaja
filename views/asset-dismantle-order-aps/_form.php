...
<?php $form = ActiveForm::begin([
 ...
 <?php //= $form->field($model, 'id_pegawai')->textInput() ?>
    ...
    <?php $dataListCustomer = yii\helpers\ArrayHelper::map(backend\models\Customer::find()->asArray()->all(), 'nomor_telepon', 'nama_customer');
	echo $form->field($model, 'id_customer')->dropDownList($dataListCustomer);
	?> 
       
    <?php $dataListCustomer = yii\helpers\ArrayHelper::map(backend\models\Customer::find()->asArray()->all(), 'nomor_telepon', 'alamat');
	echo $form->field($model, 'id_customer')->dropDownList($dataListCustomer);
	?> 
   ...
   <?php // $dataListJobClass = yii\helpers\ArrayHelper::map(backend\models\JobClass::find()->asArray()->all(), 'id_job_class', 'id_job_class');
  // 	echo $form->field($model, 'id_job_class')->dropDownList($dataListJobClass); 
  //  ?>
...
<!-- 
	...
	//echo $form->field($model, 'id_asset_item')->dropDownList($dataListAsset,
	//	['prompt' => '-Pilih-']); 
	?> -->
