...
<?php $form = ActiveForm::begin([
	...
	echo $form->field($model, 'id_customer')->dropDownList($dataListJobClass, ['disabled' => true]);
		// ['prompt' => '-Pilih-']); 
	?>

     <?php $dataListJobClass = yii\helpers\ArrayHelper::map(backend\models\Customer::find()->asArray()->all(), 'nomor_telepon', 'nama_customer');  
	    echo $form->field($model, 'nomor_telepon')->dropDownList($dataListJobClass, ['disabled' => true]);
	// 	 ['prompt' => '-Pilih-']); 
    ?>
  ...
  <?php // $dataListJobClass = yii\helpers\ArrayHelper::map(backend\models\JobClass::find()->asArray()->all(), 'id_job_class', 'namajob_class');
//	echo $form->field($model, 'id_job_class')->dropDownList($dataListJobClass,['disabled' => true]);
    ...
    <?= $form->field($model, 'alamat_customer')->textInput(); ?>
