...
/* @var $model backend\models\MaterialSalesSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="material-sales-search">
    ...
    <?= $form->field($model, 'id_material_sales') ?>

    <?= $form->field($model, 'sales_id_sales_order') ?>

    <?= $form->field($model, 'sales_harga_jual') ?>

    <?= $form->field($model, 'sales_created_id_user') ?>

    <?= $form->field($model, 'sales_created_date') ?>

    <?php // echo $form->field($model, 'sales_created_ip_address') ?>
