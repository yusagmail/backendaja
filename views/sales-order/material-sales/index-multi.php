...
<div class="box">
    <div class="box-body material-sales-index">
        ...
        <div class="callout callout-warning">
            ...
            <p>Pastikan data-data sudah lengkap dan benar. Fitur ini untuk membuat invoice, jika sudah dibuat invoice maka tidak dapat diubah lagi detail item data-datanya.<br>
            Anda bisa melewatkan bagian ini atau generate invoice setelah ini. Untuk generate invoice silakan cek bagian menu sales invoice.
            </p>

            <?= Html::a('Buat Invoice', ['/sales-invoice/update-invoice', 'i'=>$i], ['class' => 'btn btn-success btn-sm']) ?>
        </div>
    </div>
</div>
...
function sendMessagePostKodeBarang(){
  ...
  if(msgText != ""){
      ...
      $.post("post-message-session-kode-barang/", {msg: newval, iso: <?= $ip ?>}, function(data, status){
        //alert("Saving : " + data + "\nStatus: " + status);
        //$( "#msginfo").text( "Result : " + data );
        //$( "#msginfo").text( data);
        $( "#msginfo").html( data);
...
function changeOption(){
    ...
    //alert('as' + opt);
    window.location.replace("<?php echo Url::toRoute(['sales-order/view-order', 'i'=>$i]); ?>&opt="+opt);
}
</script>