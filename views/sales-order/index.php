...
<div class="box">
    <div class="box-body sales-order-index">
        ...
        <p>
            <?= Html::a('<i class="fa fa-plus"></i> Tambah Sales Order', ['create'], ['class' => 'btn btn-success']) ?>
        </p>
                        ...
                        if($data->status_invoice == 'INVOICE'){
                            ...
                            return Html::a(
                                ...
                                [
                                    ...
                                    'data' => [
                                        'confirm' => 'Anda yakin mau menghapus data sales order? Jika iya berarti data-data produk yang sudah dimasukkan akan ikut dihapus juga.',
                                        //'method' => 'post',
                                    ],
                                ],
