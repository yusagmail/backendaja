...
<div class="box box-success">
    <?php echo $this->render('_search-varian', ['model' => $searchModel]); ?>
</div>
<?php
...
<?php
		...
		echo '</ul>';
		$urlgenerate = Url::toRoute(['generate-varian', 'c'=>$tableName, 'v'=>$varian]);
		echo '<a href="'.$urlgenerate.'" class="btn btn-sm btn-success btn-flat pull-left">GENERATE WITH VARIAN</a>';
		echo '</div>
		</div>
		';
	}
