...
/* @var $searchModel backend\models\SubcontractorSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Master Kontraktor Makloon';
...
<div class="box">
    <div class="box-body customer-index">
        ...
        <p>
            <?= Html::a('<i class="fa fa-plus"></i> Tambah Master Kontraktor Makloon', ['create'], ['class' => 'btn btn-success']) ?>
        </p>
