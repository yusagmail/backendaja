...
$this->title = CommonActionLabelEnum::LIST.' '. AppVocabularySearch::getValueByKey('Type Asset 5');
$this->params['breadcrumbs'][] = $this->title;

$datalist = ['' => 'Choose', '1' => 'Active', '0' => 'No Active']
?>
<div class="type-asset5-index box box-success">
    ...
    <div class="box-header with-border">
        <p>
            <?= Html::a(CommonActionLabelEnum::CREATE.' '. AppVocabularySearch::getValueByKey('Type Asset 5'), ['create'], ['class' => 'btn btn-success']) ?>
        </p>
    </div>
    ...
    <div class="box-body table-responsive">
        ...
        $listColumnDynamic = AppFieldConfigSearch::getListGridView(TypeAsset5::tableName());
