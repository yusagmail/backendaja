...
$this->title = CommonActionLabelEnum::DETAIL.' '. AppVocabularySearch::getValueByKey('Type Asset 5');
...
?>
<div class="type-asset5-view box box-success">
    ...
    <div class="box-header with-border">
        ...
        <?php
        $tableName = TypeAsset5::tableName(); //Ini yang diganti (Nama tabel dari modelnya)
