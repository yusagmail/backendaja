...
$this->title =  CommonActionLabelEnum::DETAIL.' '. AppVocabularySearch::getValueByKey('Type Asset 4');
...
?>
    <div class="type-asset4-view box box-success">
    ...
    <div class="box-header with-border">
        ...
        <?php
        $tableName = TypeAsset4::tableName(); //Ini yang diganti (Nama tabel dari modelnya)
