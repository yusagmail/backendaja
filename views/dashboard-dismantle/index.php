...
$this->title = 'Dashboard Dismantle';
...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Laporan Barang Dismantle </h3>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-blue">
                                <div class="inner">
                                    <!--                    <h3>0</h3>-->
                                    <h3> <?= AssetItemIncidentSearch::getTotalAssetReport()?></h3>
                                    <p> Total Order</p>
                                </div>
                                <div class="icon">
                                    <i class="ionicons ion-alert-circled"></i>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Grafik Aset yang ada di gudang</h3>
