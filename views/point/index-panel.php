...
<div class="box" style="height: 300px; overflow-x: auto;">
    ...
    <div id="index-panel" class="box-body point-index overflow-x: auto; width: 100%;" style="padding: 4px;">
        ...
        */ ?>
        ...
        <?= Html::a('Flat Style', ['point/map', 'mapstyle'=>"custom"], ['class' => 'btn btn-info btn-xs']) ?>
        <?= Html::a('Map Street Style', ['point/map', 'mapstyle'=>"mapstreet"], ['class' => 'btn btn-warning btn-xs']) ?>
        <?php /*
        <p>
