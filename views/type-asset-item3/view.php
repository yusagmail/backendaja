...
$this->title = CommonActionLabelEnum::DETAIL." ". AppVocabularySearch::getValueByKey('Type Asset Item 3');
...
?>
<div class="type-asset-item3-view box box-success">
...
<!--    <h1>--><?php //Html::encode($this->title) ?><!--</h1>-->
    ...
    <div class="box-header with-border">
        ...
        <?php
        $tableName = TypeAssetItem3::tableName(); //Ini yang diganti (Nama tabel dari modelnya)
