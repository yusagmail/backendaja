...
function createRoom(roomData) {
  ...
  heightWall = 0.5;
  const roomGeometry = new THREE.BoxGeometry(length, heightWall, width);
  ...
  createWall(length, heightWall, 0.2, start_x + length / 2, 1, start_y); // back wall
  createWall(length, heightWall, 0.2, start_x + length / 2, 1, start_y + width); // front wall
  createWall(0.2, heightWall, width, start_x, 1, start_y + width / 2); // left wall
  createWall(0.2, heightWall, width, start_x + length, 1, start_y + width / 2); // right wall
