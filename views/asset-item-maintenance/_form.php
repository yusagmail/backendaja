...
<script>
    $(document).ready(function () {
        ...
        today = yyyy + '-' + mm + '-' + dd;
        $("#assetitemmaintenance-maintenance_date").datepicker({dateFormat: 'Y-mm-dd'}).val(today);
        $("#assetitemmaintenance-maintenance_finish_date").datepicker({dateFormat: 'Y-mm-dd'}).val(today);
        $("#assetitemmaintenance-received_date").datepicker({dateFormat: 'Y-mm-dd'}).val(today);
    });
</script>
