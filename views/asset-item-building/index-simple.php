...
$this->title = CommonActionLabelEnum::LIST_ALL ." " . AppVocabularySearch::getValueByKey(' of Aset');
...
<div class="asset-item-index box box-primary">
    ...
    <div class="box-header with-border">
        <p>
            ...
            <!-- <?= Html::a(CommonActionLabelEnum::IMPORTFILE, ['import-file'], ['class' => 'btn btn-success']) ?> -->
<!-- 
 <?= Html::button('Import File',
                ['value' => Url::to(['/asset-item-main/import-file']),
                    'title' => 'Upload Data', 'class' => 'Button btn btn-success']); ?> -->
...
<?php
    ...
    <div class="box-body">
        ...
        <?= GridView::widget([
            ...
            'panel' => ['type' => 'primary', 'heading' => 'Asset'],
                ...
                */
                ['class' => 'yii\grid\ActionColumn',
                    ...
                    'buttons' => [
                        'status-action' => function ($url, $model, $key) {     // render your custom button
                            $ic = EncryptionDB::encryptor('encrypt', $model->id_asset_item);
                            $urlpeta = Url::toRoute(['/asset-item-building/view-detail', 'c' => $ic]);
