...
/* @var $searchModel backend\models\SupplierRawSearch */
...
<div class="box">
    <div class="box-body customer-index">
        ...
        <div class="callout callout-info">
            ...
            <p>Fitur ini digunakan untuk memetakan suplier untuk data master greige.</p>
        </div>

        <p>
            <?= Html::a('<i class="fa fa-plus"></i> Tambah Master Supplier', ['create'], ['class' => 'btn btn-success']) ?>
        </p>
