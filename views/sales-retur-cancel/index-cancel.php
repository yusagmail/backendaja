...
<div class="box">
    <div class="box-body sales-order-index">
        ...
        <p>Fitur ini untuk melakukan pencatatan terkaitan cancel invoice. Cancel invoice adalah membatalkan seluruh invoice dan semua barang /items yang telah dijual. <Br>Barang-barang yang telah dijual akan kembali ke stock/gudang.
        <br>
            ...
            'columns' => [
                ...
                [
                    ...
                    'value' => function ($data) {
                        ...
                        if($data->status_invoice == 'INVOICE'){
                            return Html::a(
                                '<i class="fa fa-fw fa-level-down"></i> CANCEL',
                                ['sales-retur-cancel/view-cancel', 'i' => $i],
