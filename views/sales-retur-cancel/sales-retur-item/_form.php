...
<div class="sales-retur-item-form">

    <?php $form = ActiveForm::begin(); ?>

    <?= $form->field($model, 'retur_id_sales_order')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'retur_id_outlet_penjualan')->textInput() ?>

    <?= $form->field($model, 'retur_created_id_user')->textInput() ?>

    <?= $form->field($model, 'retur_created_date')->textInput() ?>

    <?= $form->field($model, 'retur_created_ip_address')->textInput(['maxlength' => true]) ?>
