...
$this->title = CommonActionLabelEnum::DETAIL." ". AppVocabularySearch::getValueByKey('Type Asset Item 1');
...
?>
<div class="type-asset-item1-view box box-success">
    ...
    <div class="box-header with-border">
        ...
        <?php
        $tableName = TypeAssetItem1::tableName(); //Ini yang diganti (Nama tabel dari modelnya)
