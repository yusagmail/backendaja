...
<div class="box box-success by-location-search">
    ...
    <div class="box-body">
        ...
        ?>
        <?php $dataKabupaten = ArrayHelper::map(Propinsi::find()->orderBy(['nama_propinsi' => SORT_ASC])->asArray()->all(), 'id_propinsi', 'nama_propinsi');
    ...
    ']
        ...
        echo $form->field($model, 'id_kabupaten')->widget(Select2::classname(), [
            ...
            $( "select#locationsearch-id_kecamatan" ).html( data );
            });
    ...
    ']
        ...
        echo $form->field($model, 'id_kecamatan')->widget(Select2::classname(), [
            ...
            $( "select#locationsearch-id_kelurahan" ).html( data );
            });
    ...
    ']
        ...
        <?php $dataKelurahan = ArrayHelper::map(Kelurahan::find()->orderBy(['nama_kelurahan' => SORT_ASC])->asArray()->all(), 'id_kelurahan', 'nama_kelurahan');
