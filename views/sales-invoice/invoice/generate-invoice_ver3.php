...
<head>
	...
	<style>
		...
		.invoice-box table tr.item-bottom td {
						...
						<tr class="top">
							<td colspan="5">
								...
								<table width="100%" border="0" style="margin-top:-30px;">
									<td width="10%" style="text-align: center; font-size: 18px;">
										INVOICE
									</td>
								</table>
								<table width="100%" border="0">
				...
				<tr class="details">
					...
					<td>1000</td>
						...
						<tr class="item-bottom">
							...
							<td><?= $totalYard ?></td>
							<td></td>
							<td style="font-size: 20px;"><?= \common\helpers\ContentStringManipulator::formatRp($total) ?></td>
						</tr>
						<tr>
							<td colspan="5">Terbilang : <i><?= ucwords(\common\helpers\CurrencyManipulator::terbilangRupiah($total)) ?> rupiah</i>
								...
								<?php
									if($mode == "lunas"){
										if($model->status_pembayaran == "LUNAS"){
											echo "PEMBAYARAN SUDAH LUNAS";
											echo "<br><i>Invoice ini sekaligus sebagai bukti pembayaran yang syah</i>";
										}			
									}
								?>
