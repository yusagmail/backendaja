						...
						<tr class="top">
							<td colspan="4">
								<table width="100%" border="0">
									...
									<td>
										<!-- Domivatex Lestari Abadi Jalan Sukabirus, Nanjung, Kec. Margaasih Bandung, Jawa Barat 40217, Indonesia -->
										<center><?= $model->outletPenjualan->alamat ?></center>
									</td>
								</table>
								<table width="100%" border="0">
									<tr>
									...
									<tr>
										<td width="50%">
											Tanggal : <?= common\helpers\Timeanddate::getShortDateIndo($model->tanggal_order) ?><br />
											No. Invoice : <?= $model->nomor_sales_order ?><br />
											No. Surat Jalan :
										</td>
										<!-- <td colspan="14"></td>
										<td colspan="14"></td> -->
						...
						<tr class="information">
							<td colspan="4">
								<table>
									<tr>
										<!-- <td>
											Domivatex Lestari Abadi<br />
											Jalan Sukabirus, Nanjung, Kec. Margaasih<br />
											Bandung, Jawa Barat 40217, Indonesia
										</td> -->
										<td></td>
										<td></td>
										<td>
				...
				<tr class="details">
					...
					<td>1000</td>
						...
						<?php foreach ($data as $item) { ?>
							<tr class="item">
								<td><?= $item->mater->nama ?> - <?= $item->materialKategori1->nama ?> - <?= $item->materialKategori3->nama ?></td>
								<td><?= $item->yard ?></td>
