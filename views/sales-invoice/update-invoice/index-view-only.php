        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                if($data->status_pembayaran == "LUNAS"){
                    echo Html::a(
                        '<i class="fa fa-print input-lg"></i> CETAK INVOICE DAN BUKTI LUNAS',
                        ['sales-invoice/generate-invoice', 'i' => $i, "mode"=>"lunas"],
                        [
                            'class' => 'btn btn-info btn-block input-lg',
                            'data' => [
                                //'confirm' => 'Anda yakin mau menghapus data ini?',
                ...
                <?php
                    $i = \common\utils\EncryptionDB::encryptor('encrypt',$data->id_sales_order);
                        ...
                        if($data->status_pembayaran == 'BELUM' || $data->status_pembayaran == 'PARTIAL' || $data->status_pembayaran == 'LEBIH BAYAR'){
                            $res = "";
                            $res .= '
                              <div class="callout callout-info-ok">
                                <p>Fitur untuk melakukan pembayaran.<br>
                                Anda bisa melewatkan bagian ini dan bisa dilakukan nanti dibagian sales pembayaran.
                                </p>
                              </div>
                            ';
                            ...
                            $res .= ''.Html::a(
                                ...
                                ['class' => 'btn btn-info input-lg btn-block']
                            );
