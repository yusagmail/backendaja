...
/* @var $searchModel backend\models\BasicPackingSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Basic Packing';
...
<div class="box">
    <div class="box-body basic-packing-index">
        ...
        <p>
            <?= Html::a('<i class="fa fa-plus"></i> Tambah Basic Packing', ['create'], ['class' => 'btn btn-success']) ?>
        </p>
