...
$this->title = 'Rekapitulasi Stock - Level 2';
                ...
                [
                    ...
                    'value' => function ($data) {
                        ...
                        return Html::a(
                            ...
                            ['material-finish/rekapitulasi-stok-detail-kat1', 'im' => $data->id_material, 'ig'=>$data->id_gudang, 'ik1'=>$data->id_material_kategori1],
