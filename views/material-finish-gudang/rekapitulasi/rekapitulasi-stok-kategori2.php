...
$this->title = 'Rekapitulasi Stock - Level 3';
                ...
                [
                    ...
                    'value' => function ($data) {
                        ...
                        return Html::a(
                            ...
                            ['material-finish/rekapitulasi-stok-detail-kat2', 'im' => $data->id_material, 'ig'=>$data->id_gudang, 'ik1'=>$data->id_material_kategori1,'ik2'=>$data->id_material_kategori2],
