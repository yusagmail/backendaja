...
$this->title = 'Rekapitulasi Stock - Level 4 - Yard';
                ...
                [
                    ...
                    'value' => function ($data) {
                        ...
                        return Html::a(
                            ...
                            ['material-finish/rekapitulasi-stok-detail-kat3-yard', 'im' => $data->id_material, 'ig'=>$data->id_gudang,
                            'ik1'=>$data->id_material_kategori1,'ik2'=>$data->id_material_kategori2,
                            'ik3'=>$data->id_material_kategori3, 'yard'=>$data->yard],
