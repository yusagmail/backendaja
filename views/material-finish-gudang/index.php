...
<div class="box">
    <div class="box-body material-finish-index">
        ...
        <p>
            <?= Html::a('<i class="fa fa-plus"></i> Tambah Barang Jadi', ['create'], ['class' => 'btn btn-success']) ?>
        </p>
...
$dataListPallete = ['' => 'Pilih'] + \yii\helpers\ArrayHelper::map(\backend\models\PalletGudang::find()
        //->where(['id_parent_topnav' => 0])
         ->orderBy([
            'nomor_pallet' => SORT_ASC
            ])
        ->all(), 'id_pallet_gudang', 'nomor_pallet');
...
?>
        ...
        <?= GridView::widget([
            ...
            'columns' => [
                ...
                [
                    'attribute' => 'id_pallet_gudang',
                    'format' => 'raw',
                    'value' => function ($data) {
                        if (isset($data->pallete)) {
                            return $data->pallete->nomor_pallet;
                        } else {
                            return "--";
                        }
                    },
                    'filter'=>Html::activeDropDownList($searchModel, 'id_pallet_gudang', $dataListPallete, ['class' => 'form-control']),
                ],
                //'no_urut_kode',
                //'barcode_kode',
                //'deskripsi',
