...
<div class="box box-success by-location-search">
    ...
    <div class="box-body">
        ...
        $form = ActiveForm::begin([
            'layout' => 'horizontal',
            //'action' => ['location-unit/list-owned'],
            'method' => 'get',
            'fieldConfig' => [
        ...
        ?>
        <?php $dataLocation = ArrayHelper::map(Location::find()->asArray()->all(), 'id_location', 'location_name');
        ...
        <?php $dataOwner = ArrayHelper::map(Owner::find()->asArray()->all(), 'id_owner', 'name');
        ...
        ?>
        <?php
        $label1 = backend\models\AppFieldConfigSearch::getLabelName(LocationUnit::tableName(), "label1");
        ?>
        <?= $form->field($model, 'label1')->label($label1) ?>
		<?php
			$label1 = backend\models\AppFieldConfigSearch::getLabelName(LocationUnit::tableName(), "Address");
		?>
		<?= $form->field($model, 'locationAddress')->label($label1) ?>

        <?php $dataMstStatus1 = ArrayHelper::map(MstStatus1::find()->asArray()->all(), 'id_mst_status', 'mst_status');
        echo $form->field($model, 'id_mst_status1')->widget(Select2::classname(), [
            'data' => $dataMstStatus1,
            'pluginOptions' => [
                'allowClear' => true
            ],
