...
*/
    ...
    $jsonFilename = \backend\models\AssetItemMappingSearch::generateFileGeojson();
    echo $jsonFilename;
...
<div class="">
            ...
            $labelDetail = \backend\models\AppSettingSearch::getValueByKey("MAIN-ASSET-NAME", "Point");
          ...
          echo $this->render('_load_data_point_v2', [
            'labelDetail' => $labelDetail,
          ]);
          ?>
            ...
            <div id="mydiv" class="box">
              <!-- Include a header DIV with the same name as the draggable DIV, followed by "header" -->
                ...
                <div class="box-header with-border" id="mydivheader">
                    <h3 class="box-title">List <?=$labelDetail ?> <span id="alertMsg" class="alertMsg"></span></h3> 
        ...
        ?>
            ...
            <div id="mydiv2" class="box" style="display:none">
              ...
              <div class="box-header with-border" id="mydiv2header">
                    <h3 class="box-title">Add <?=$labelDetail ?> </h3>
                    <div class="box-tools pull-right">
                    <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                    </button>
            ...
            <div id="mydiv3" class="box" style="display:none">
              ...
              <div class="box-header with-border" id="mydiv3header">
                    <h3 class="box-title">Update <?=$labelDetail ?> </h3>
                    <div class="box-tools pull-right">
                    <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                    </button>
