...
$this->title = CommonActionLabelEnum::DETAIL.' '. AppVocabularySearch::getValueByKey('Type Asset 3');
$this->params['breadcrumbs'][] = ['label' => CommonActionLabelEnum::LIST.' '. AppVocabularySearch::getValueByKey('Type Asset 3'), 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
\yii\web\YiiAsset::register($this);
?>
<div class="type-asset3-view box box-success">
    ...
    <div class="box-header with-border">
        ...
        <?php
        $tableName = TypeAsset3::tableName(); //Ini yang diganti (Nama tabel dari modelnya)
