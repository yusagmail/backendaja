...
$this->title = AppVocabularySearch::getValueByKey('Kualitas Aset');
...
NB : Kualitas dihitung dari setiap update kondisi aset (menu update kondisi aset)
<div class="asset-item-index box box-primary">
   ...
   <div class="box-body table-responsive">
		...
		*/
		...
		$listColumnDynamic[] = [
			'label' => AppVocabularySearch::getValueByKey('Kualitas Aset'),
		  ];
