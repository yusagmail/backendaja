            ...
            'columns' => [
                ...
                [
                    ...
                    'urlCreator' => function ($action, $model, $key, $index) {
                        if ($action === 'view') {
                            $url = Url::base() . '/outsourcing-process-raw-item/view?id=' . $model->id_outsourcing_process_raw_item;
                            return $url;
                        }

                        if ($action === 'update') {
                            $url = Url::base() . '/outsourcing-process-raw-item/update?id=' . $model->id_outsourcing_process_raw_item;
                            return $url;
                        }
                        if ($action === 'delete') {
                            $url = Url::base() . '/outsourcing-process-raw-item/delete?id=' . $model->id_outsourcing_process_raw_item;
                            return $url;
                        }
                    }
                ],
