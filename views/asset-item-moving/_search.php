...
<div class="asset-item-search">
    <div class="box-body">
        ...
        <?php $dataAssetType1 = ArrayHelper::map(TypeAssetItem1::find()->asArray()->all(), 'id_type_asset_item1', 'type_asset_item'); ?>
        <?= $form->field($model, 'id_type_asset_item1')->dropDownList($dataAssetType1,
            ['prompt' => '--Semua--']); ?>

        <?php $dataAssetType2 = ArrayHelper::map(TypeAssetItem2::find()->asArray()->all(), 'id_type_asset_item2', 'type_asset_item'); ?>
        ...
        <?php $dataAssetType1 = ArrayHelper::map(TypeAsset2::find()->asArray()->all(), 'id_type_asset', 'type_asset'); ?>
        <?= $form->field($model, 'id_type_asset')->dropDownList($dataAssetType1,
            ['prompt' => '--Semua--']); ?>
