...
$this->title = AppVocabularySearch::getValueByKey('Stock').' '. AppVocabularySearch::getValueByKey('Asset Master');
...
<!--    <h1>--><?php //Html::encode($this->title) ?><!--</h1>-->
    ...
    echo $this->render('/asset-item-list/_inner_view_controller', [
