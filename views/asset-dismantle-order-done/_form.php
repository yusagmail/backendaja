...
<?php $form = ActiveForm::begin([
    ...
    <?php //= $form->field($model, 'id_asset_dismantle_order')->textInput() ?>
    ...
    <?= $form->field($model, 'is_approved')->dropDownList(
        ['0' => 'Diterima'],['prompt'=>'--PIlih--']
    ) ?>

    <?php //= $form->field($model, 'approval_user_id')->textInput() ?>
    ...
    <?php //= $form->field($model, 'approval_ip_address')->textInput(['maxlength' => true]) ?>
