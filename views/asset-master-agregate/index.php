...
$dataList2 = ['' => 'Choose'] + ArrayHelper::map(TypeAsset2::find()->all(), 'id_type_asset', 'type_asset');
?>
<div class="asset-master-index box box-success">
    ...
    <div class="box-body">
		...
		echo GridView::widget([
            ...
            'panel' => ['type' => 'primary', 'heading' => 'Asset Master'],
...
//                'id_asset_code',
                ...
                [
                    'attribute' => 'typeAsset2.type_asset',
                    'filter'=>Html::activeDropDownList($searchModel, 'id_type_asset2', $dataList1, ['class' => 'form-control']),
                ],
                */
                'deskripsi',
                'date',
