...
<div class="material-in-item-proc-form">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <?= $form->field($model, 'label_barcode_number1')->textInput(['readonly' => true]) ?>

            <?= $form->field($model, 'label_barcode_number2')->textInput(['readonly' => true]) ?>

            <?= $form->field($model, 'label_barcode_number3')->textInput(['readonly' => true]) ?>
        </div>
    </div>
    <?php /*
