        ...
        <div class="row">
		    ...
		    */ ?>
            ...
            <div class="col-md-6">
                ...
                <?php
                    if($model->label_barcode_number1 != ""){
                        $label1 = Html::a(
                        'CETAK',
                        ['material-in/generate-barcode-material', 'id_item' => $model->id_material_in_item_proc, 'id_parent' => $model->id_material_in, 'label' => 1,],
                        ['class' => 'btn btn-warning btn-sm']);
                    }else{
                        $label1 = "";
                    }

                    if($model->label_barcode_number2 != ""){
                        $label2 = Html::a(
                        'CETAK',
                        ['material-in/generate-barcode-material', 'id_item' => $model->id_material_in_item_proc, 'id_parent' => $model->id_material_in, 'label' => 2,],
                        ['class' => 'btn btn-warning btn-sm']);
                    }else{
                        $label2 = "";
                    }

                    if($model->label_barcode_number3 != ""){
                        $label3 = Html::a(
                        'CETAK',
                        ['material-in/generate-barcode-material', 'id_item' => $model->id_material_in_item_proc, 'id_parent' => $model->id_material_in, 'label' => 3,],
                        ['class' => 'btn btn-warning btn-sm']);
                    }else{
                        $label3 = "";
                    }
                ...
                <?= $form->field($model, 'label_barcode_number2')->textInput(['readonly' => true])->label($label2) ?>

                <?= $form->field($model, 'label_barcode_number3')->textInput(['readonly' => true])->label($label3) ?>
