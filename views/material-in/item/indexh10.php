    ...
    <div style="overflow-x: auto; width: 100%;">
        <?= GridView::widget([
            ...
            'columns' => [
                ...
                [
                    'attribute' => 'yard_hasil7',
                    'format' => 'raw',
                    'value' => function ($data) use ($ip) {
                        return displayLabelYardHasil(7, $data);
                    }
                ],
                [
                    'attribute' => 'yard_hasil8',
                    'format' => 'raw',
                    'value' => function ($data) use ($ip) {
                        return displayLabelYardHasil(8, $data);
                    }
                ],
                [
                    'attribute' => 'yard_hasil9',
                    'format' => 'raw',
                    'value' => function ($data) use ($ip) {
                        return displayLabelYardHasil(9, $data);
                    }
                ],
                [
                    'attribute' => 'yard_hasil10',
                    'format' => 'raw',
                    'value' => function ($data) use ($ip) {
                        return displayLabelYardHasil(10, $data);
                    }
                ],
                //'yard_hasil2',
                /*
