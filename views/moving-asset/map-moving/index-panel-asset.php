...
<div class="box" style="height: 300px; overflow-x: auto;">
    ...
    <div id="index-panel" class="box-body point-index overflow-x: auto; width: 100%;" style="padding: 4px;">
        ...
        <?= Html::a('Flat Style', ['map-moving', 'mapstyle'=>"custom"], ['class' => 'btn btn-success btn-xs']) ?>
        <?= Html::a('Map Street Style', ['map-moving', 'mapstyle'=>"mapstreet"], ['class' => 'btn btn-warning btn-xs']) ?>
        <?php /*
        <p>
        ...
        */ 
        ...
        <?php 
        \yii\widgets\Pjax::begin(['id' => 'pjax_id_sensor', 'options'=> ['class'=>'pjax', 'loaderId'=>'loader_id_sensor', 'neverTimeout'=>true]]);
        ?>
            <?= GridView::widget([
            ...
            'columns' => [
                ...
                ['class' => 'yii\grid\CheckboxColumn',
                    ...
                    'checkboxOptions' => function($model, $key, $index, $widget) use ($defaultClear){
                        ...
                        if ($model->id_sensor >0) {
                                return [
                                    'value' => $model->id_sensor, 
                                    'id' => 'el'.$model->id_sensor,
                                    'checked' => !$defaultClear, 
                                    'data-checkid'=> $model->id_sensor 
                                ];
                            }
                ...
                */
                ...
                [
                    ...
                    'format' => 'raw',
                    'value' => function ($data)  {
                        return Html::a('<span class="glyphicon glyphicon-trash"></span>', ['delete', 'id' => $data->id_sensor], [
                            //'class' => 'btn btn-danger',
                            'datadel-pointid' => $data->id_sensor,
                            'data' => [
                ...
                */
                [
                    ...
                    'value' => function ($data)  {
                        return '
                            <button class="viewrow1 glyphicon glyphicon-eye-open" data-viewid="' . $data->id_sensor . '" data-lat="' . $data->data_value1 . '" data-long="' . $data->data_value2 . '"></button>
                ...
                [
                    ...
                    'format' => 'raw',
                    'value' => function ($data)  {
                        return '<button class="deleterow glyphicon glyphicon-trash" data-id="' . $data->id_sensor . '"></button>';
                ...
                */
                ...
                [
                    ...
                    'format' => 'raw',
                    'value' => function ($data)  {
                        return '<input type="text" data-sasaran="' . $data->id_sensor . '" data-triwulan="' . $this->title . '">';
        ...
        $('button[data-id]').on('click', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.pjax.reload({container: '#pjax_id_sensor', async: false});
