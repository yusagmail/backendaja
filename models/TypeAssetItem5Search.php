...
/**
 * TypeAssetItem5Search represents the model behind the search form of `backend\models\TypeAssetItem5`.
 */
class TypeAssetItem5Search extends TypeAssetItem5
{
    /**
     * {@inheritdoc}
     */
