...
/**
 * SensorAlertHistorySearch represents the model behind the search form of `backend\models\SensorAlertHistory`.
 */
class SensorAlertHistorySearch extends SensorAlertHistory
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id_sensor_alert_history', 'id_sensor', 'channel_number', 'is_case_open'], 'integer'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            'id_sensor_alert_history' => $this->id_sensor_alert_history,
