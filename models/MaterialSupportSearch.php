...
/**
 * MaterialSupportSearch represents the model behind the search form of `backend\models\MaterialSupport`.
 */
class MaterialSupportSearch extends MaterialSupport
{
