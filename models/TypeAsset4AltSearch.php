...
/**
 * TypeAsset4Search represents the model behind the search form of `backend\models\TypeAsset4`.
 */
class TypeAsset4Search extends TypeAsset4
{
    /**
     * {@inheritdoc}
     */
