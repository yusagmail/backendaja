...
/**
 * TypeAsset2Search represents the model behind the search form of `backend\models\TypeAsset2`.
 */
class TypeAsset2Search extends TypeAsset2
{
    /**
     * {@inheritdoc}
     */
