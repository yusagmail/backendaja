...
/**
 * MaterialKategori1Search represents the model behind the search form of `backend\models\MaterialKategori1`.
 */
class MaterialKategori1Search extends MaterialKategori1
{
