...
/**
 * AssetItemDeletionSeach represents the model behind the search form of `backend\models\AssetItemDeletion`.
 */
class AssetItemDeletionSeach extends AssetItemDeletion
{
    /**
     * {@inheritdoc}
     */
