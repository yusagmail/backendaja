 ...
 */
class AssetDismantleOrderApsSearch extends AssetDismantleOrder
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id_asset_dismantle_order', 'id_supervisor', 'id_job_class', 'nomor_telepon', 'order_increment', 'year', 'id_asset_item', 'id_customer', 'created_id_user'], 'integer'],
