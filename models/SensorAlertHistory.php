...
/**
 * This is the model class for table "sensor_alert_history".
 *
 * @property string $id_sensor_alert_history
 ...
 */
class SensorAlertHistory extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            'id_sensor_alert_history' => 'Id Sensor Alert History',
            'id_sensor' => 'Id Sensor',
            'channel' => 'Channel',
