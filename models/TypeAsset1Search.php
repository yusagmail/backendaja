...
/**
 * TypeAsset1Search represents the model behind the search form of `backend\models\TypeAsset1`.
 */
class TypeAsset1Search extends TypeAsset1
{
    /**
     * {@inheritdoc}
     */
