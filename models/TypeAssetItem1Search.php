...
/**
 * TypeAssetItem1Search represents the model behind the search form of `backend\models\TypeAssetItem1`.
 */
class TypeAssetItem1Search extends TypeAssetItem1
{
    /**
     * {@inheritdoc}
     */
