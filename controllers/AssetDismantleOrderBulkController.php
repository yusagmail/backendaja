...
use backend\models\AssetDismantleOrderBulkSearch;
 ...
 */
class AssetDismantleOrderBulkController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $searchModel = new AssetDismantleOrderBulkSearch();
    ...
    {
        $model = new AssetDismantleOrderBulk();
    ...
    {
        if (($model = AssetDismantleOrderBulk::findOne($id)) !== null) {
            return $model;
        }
