...
use Yii;
use backend\models\AssetDismantleOrderJanji;
use backend\models\AssetDismantleOrderJanjiSearch;
 ...
 */
class AssetDismantleOrderJanjiController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $searchModel = new AssetDismantleOrderJanjiSearch();
    ...
    {
        $model = new AssetDismantleOrderJanji();
    ...
    {
        if (($model = AssetDismantleOrderJanji::findOne($id)) !== null) {
            return $model;
        }
